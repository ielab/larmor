...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="encode", help="encode/eval or "
                        "binary_entropy/query_alteration/qpp_sigma_max/qpp_nqc/qpp_smv/fusion")
    ...
    parser.add_argument("--specific_model", default="", type=str, help="The name of the specific model to run."
