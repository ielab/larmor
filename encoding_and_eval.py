...
def run_evaluation(args, models, names):
    ...
    for model_name in names:
        ...
        # results = load_search_results("./logs/res_t5xxl/search_results_fake/",
        #                               args.dataset_name,
        #                               special_id="sch_{}_{}_{}".format(args.dataset_name,
        #                                                                model_name, args.fake_id_queries))
        # Find the queries that are not in qrels
        # print("Queries that are not in qrels")

        # If special token - the labels are not available => do not run the evaluation
