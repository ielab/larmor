...
import model.contriever.src.utils as utils
...
def load_retriever(model_path, pooling="average", random_init=False):
    ...
    if os.path.exists(path):
        ...
        if "xlm" in retriever_model_id:
            ...
            model_class = Contriever
            print("Contriever")
        print("Berfore autoconfig")
        cfg = utils.load_hf(transformers.AutoConfig.from_pretrained, model_path)

        print("After autoconfig")
